...
def wellness_question_data():
    wellness_file = root_path + "/감정카테고리_통합_최종.xlsx"
    wellness_q_output = root_path + "/wellness_dialog_question_감정.txt"
...
def wellness_category_data():
    wellness_file = root_path + "/감정카테고리_통합_최종.xlsx"
    wellness_c_output = root_path + "/wellness_dialog_category_감정.txt"
...
def wellness_text_classification_data():
    wellness_category_file = root_path + "/wellness_dialog_category_감정.txt"
    wellness_question_file = root_path + "/wellness_dialog_question_감정.txt"
    wellness_text_classification_file = root_path + "/wellness_dialog_for_text_classification_감정.txt"
...
def seperate_wellness_data():
    file_path = root_path + "/wellness_dialog_for_text_classification_감정.txt"
    train_file_path = root_path + "/wellness_dialog_for_text_classification_train_감정.txt"
    test_file_path = root_path + "/wellness_dialog_for_text_classification_test_감정.txt"
